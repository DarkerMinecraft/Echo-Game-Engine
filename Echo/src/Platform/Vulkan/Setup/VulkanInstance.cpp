...
namespace Echo
{
	...
	static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(
		...
		void* pUserData)
	{
		if (pCallbackData->pMessage == "") return VK_FALSE;
		...
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT:
			EC_CORE_INFO("Validation layer: {0}", pCallbackData->pMessage)
			break;
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT:
			EC_CORE_WARN("Validation layer: {0}", pCallbackData->pMessage)
			break;
		}
	...
	void VulkanInstance::CreateInstance()
	{
		...
		{
			EC_CORE_CRITICAL("Could Not Get Validation Layer Support When Requested!")
		}

		VkApplicationInfo appInfo{};
		appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
		appInfo.pApplicationName = "Echo Engine Application";
